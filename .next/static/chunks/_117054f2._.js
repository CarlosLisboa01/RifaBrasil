        ...
        "Header.useEffect": ()=>{
            ...
            const checkAuth = {
                "Header.useEffect.checkAuth": async ()=>{
                    try {
                        setIsLoading(true);
                        const { data: sessionData, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
                        if (error) {
            ...
            const { data: authListener } = __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange({
...
_s(Header, "bTo70PstTisUYchtLMG7L5dWXAc=");
_c = Header;
var _c;
...
//# sourceMappingURL=_117054f2._.js.map